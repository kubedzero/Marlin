...
#define STRING_CONFIG_H_AUTHOR "(johnb, default config)" // Original author or contributor.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_MKS_ROBIN_PRO //JGMaker R1 customization
#endif
 ...
 */
#define SERIAL_PORT 3 //JGMaker R1 customization
...
#define MACHINE_UUID "dd6e0f13-60cf-41a0-8f44-aa1f0afb1f7c" //JGMaker R1
 ...
 */
#define X_DRIVER_TYPE  TMC2209 //JGMaker R1 customization
...
#define BED_MAXTEMP      100 //JGMaker R1 customization
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_KP  28.06 //JGMaker R1 customization
 ...
 */
#define PIDTEMPBED //JGMaker R1 customization
  ...
  #define DEFAULT_BED_KP  55.27 //JGMaker R1 customization
  #define DEFAULT_BED_KI  10.31
  #define DEFAULT_BED_KD 197.50
 ...
 */
#define X_MIN_ENDSTOP_HIT_STATE LOW //JGMaker R1 customization
#define X_MAX_ENDSTOP_HIT_STATE HIGH
#define Y_MIN_ENDSTOP_HIT_STATE LOW //JGMaker R1 customization
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 407 } //JGMaker R1 real world tweak
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 700, 700, 20, 25 } //JGMaker R1 real world tweak
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.12 // (mm) Distance from real junction edge //JGMaker R1 real world tweak
 ...
 */
#define S_CURVE_ACCELERATION //JGMaker R1 customization
 ...
 */
// #define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN //JGMaker R1 customization

// Force the use of the probe for Z-axis homing
#define USE_PROBE_FOR_Z_HOMING //JGMaker R1 customization
 ...
 */
// Note: this pin was already assigned in the pins .h file and needed removal
#define Z_MIN_PROBE_PIN PF9 //JGMaker R1 customization
 ...
 */
#define FIX_MOUNTED_PROBE //JGMaker R1 customization
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -29, 22, -0.82 } //JGMaker R1 real world tweak. Anywhere from -0.6 to -0.91 has worked. Factory was -1.2
...
// #define PROBING_MARGIN 10 //JGMaker R1 customization

// X and Y axis travel speed between probes.
// Leave undefined to use the average of the current XY homing feedrate.
#define XY_PROBE_FEEDRATE    (200*60) // (mm/min) //JGMaker R1 faster probing than homing
 ...
 */
#define MULTIPLE_PROBING 2 //JGMaker R1 customization
...
#define PROBE_OFFSET_ZMIN -10   // (mm) //JGMaker R1 customization
#define PROBE_OFFSET_ZMAX  10   // (mm)

// Enable the M48 repeatability test to test probe accuracy
#define Z_MIN_PROBE_REPEATABILITY_TEST //JGMaker R1 customization
...
#define PREHEAT_BEFORE_PROBING //JGMaker R1 customization
#if ENABLED(PREHEAT_BEFORE_PROBING)
  #define PROBING_NOZZLE_TEMP 180   // (°C) Only applies to E0 at this time //JGMaker R1 customization
...
#define INVERT_X_DIR true //JGMaker R1 customization
...
#define Z_CLEARANCE_FOR_HOMING  4   // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ... //JGMaker R1 customization
...
#define X_BED_SIZE 235 //JGMaker R1 customization
#define Y_BED_SIZE 235

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS -3 //JGMaker R1 customization
#define Y_MIN_POS -4
#define Z_MIN_POS 0
#define X_MAX_POS 243 //JGMaker R1 real-world tweak based on measurements
 ...
 */
#define FILAMENT_RUNOUT_SENSOR //JGMaker R1 customization
#if ENABLED(FILAMENT_RUNOUT_SENSOR)
  #define FIL_RUNOUT_ENABLED_DEFAULT true // Enable the sensor on startup. Override with M412 followed by M500.
  #define NUM_RUNOUT_SENSORS   1          // Number of sensors, up to one per extruder. Define a FIL_RUNOUT#_PIN for each.

  #define FIL_RUNOUT_STATE     HIGH        // Pin state indicating that filament is NOT present. //JGMaker R1 customization
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 25 //JGMaker R1 customization
...
#define AUTO_BED_LEVELING_UBL //JGMaker R1 customization
...
#define ENABLE_LEVELING_AFTER_G28 //JGMaker R1 customization
...
//#define PREHEAT_BEFORE_LEVELING
  ...
  #define LEVELING_NOZZLE_TEMP 180   // (°C) Only applies to E0 at this time //JGMaker R1 customization
...
//#define DEBUG_LEVELING_FEATURE
   ...
   */
  #define G26_MESH_VALIDATION //JGMaker R1 customization
  ...
  #define MESH_INSET 0              // Set Mesh bounds as an inset region of the bed //JGMaker R1 customization
  #define GRID_MAX_POINTS_X 7      // Don't use more than 15 points per axis, implementation limited.
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X

  #define UBL_HILBERT_CURVE       // Use Hilbert distribution for less travel when probing multiple points //JGMaker R1 customization

  #define UBL_TILT_ON_MESH_POINTS         // Use nearest mesh points with G29 J for better Z reference //JGMaker R1 customization
 ...
 */
#define Z_SAFE_HOMING //JGMaker R1 customization
...
#define HOMING_FEEDRATE_MM_M { (100*60), (100*60), (4*60) } //JGMaker R1 customization

// Edit homing feedrates with M210 and MarlinUI menu items
#define EDITABLE_HOMING_FEEDRATE //JGMaker R1 customization
 ...
 */
#define EEPROM_SETTINGS     // Persistent storage with M500 and M501 //JGMaker R1 customization
//#define DISABLE_M503        // Saves ~2700 bytes of flash. Disable for release!
#define EEPROM_CHITCHAT       // Give feedback on EEPROM commands. Disable to save flash.
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
#if ENABLED(EEPROM_SETTINGS)
  #define EEPROM_AUTO_INIT  // Init EEPROM automatically on any errors. //JGMaker R1 customization
...
#define PREHEAT_1_TEMP_HOTEND 200 //JGMaker R1 customization
 ...
 */
#define NOZZLE_PARK_FEATURE //JGMaker R1 customization for filament change

#if ENABLED(NOZZLE_PARK_FEATURE)
  // Specify a park position as { X, Y, Z_raise }
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MIN_POS + 10), 20 } //JGMaker R1 customization
 ...
 */
#define PRINTCOUNTER //JGMaker R1 customization
 ...
 */
#define SDSUPPORT //JGMaker R1 customization
